...
extends JFrame {
    ...
    public AutofocusJFrame() {
        this.initComponents();
        this.setTitle("A small tool to export Metamorph movies");
    ...
    private void initComponents() {
        ...
        this.dirButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.dirButtonActionPerformed(evt);
            }
        });
        this.tfFirstTP.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.tfFirstTPActionPerformed(evt);
            }
        });
        this.tfFirstTP.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                AutofocusJFrame.this.tfFirstTPFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                AutofocusJFrame.this.tfFirstTPFocusLost(evt);
            }
        });
        this.jTextField2.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.jTextField2ActionPerformed(evt);
            }
        });
        this.jTextField2.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                AutofocusJFrame.this.jTextField2FocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                AutofocusJFrame.this.jTextField2FocusLost(evt);
            }
        });
        this.tfFirstZ.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.tfFirstZActionPerformed(evt);
            }
        });
        this.tfFirstZ.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                AutofocusJFrame.this.tfFirstZFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                AutofocusJFrame.this.tfFirstZFocusLost(evt);
            }
        });
        this.tfLastTP.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.tfLastTPActionPerformed(evt);
            }
        });
        this.tfLastTP.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                AutofocusJFrame.this.tfLastTPFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                AutofocusJFrame.this.tfLastTPFocusLost(evt);
            }
        });
        this.tfLastZ.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.tfLastZActionPerformed(evt);
            }
        });
        this.tfLastZ.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                AutofocusJFrame.this.tfLastZFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                AutofocusJFrame.this.tfLastZFocusLost(evt);
            }
        });
        this.jLabel1.setText("First time point");
        this.jLabel2.setText("Planes above focal plane");
        this.jLabel3.setText("Last time point");
        this.jLabel4.setText("Planes below focal plane");
        this.coolButton.setText("Cool");
        this.coolButton.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                AutofocusJFrame.this.coolButtonActionPerformed(evt);
            }
        });
    ...
    private void coolButtonActionPerformed(ActionEvent evt) {
        ...
        File exportDir = new File(this.currentDirectory + File.separator + "exported_" + this.baseName);
        if (!exportDir.exists()) {
            exportDir.mkdir();
        }
        this.exportData(exportDir);
    ...
    private boolean exportData(File targetDir) {
        if (this.currentDirectory == null || this.aFileName == null) {
            return false;
        }
        File dir = new File(this.currentDirectory);
        double vollath4_term1 = 0.0;
        double vollath4_term2 = 0.0;
        double[] vollath4 = null;
        ...
        for (int iF = 0; iF < theFiles.length; ++iF) {
            ...
            try {
                ...
                vollath4 = new double[depth];
                for (int iSlice = 0; iSlice < depth; ++iSlice) {
                    int iN;
                    int iM;
                    ImageProcessor theSlice = stk.getProcessor(iSlice + 1);
                    vollath4_term1 = 0.0;
                    for (iM = 1; iM <= width - 1; ++iM) {
                        for (iN = 1; iN <= height; ++iN) {
                            System.out.println("Pix: " + theSlice.getPixel(iM - 1, iN - 1) * theSlice.getPixel(iM, iN - 1) + ", Slice " + iSlice + ": " + (vollath4_term1 += (double)(theSlice.getPixel(iM - 1, iN - 1) * theSlice.getPixel(iM, iN - 1))));
                        }
                    }
                    vollath4_term2 = 0.0;
                    for (iM = 1; iM <= width - 2; ++iM) {
                        for (iN = 1; iN <= height; ++iN) {
                            System.out.println("Pix: " + theSlice.getPixel(iM - 1, iN - 1) * theSlice.getPixel(iM, iN - 1) + ", Slice " + iSlice + ": " + (vollath4_term2 += (double)(theSlice.getPixel(iM - 1, iN - 1) * theSlice.getPixel(iM + 1, iN - 1))));
                        }
                    }
                    vollath4[iSlice] = vollath4_term1 - vollath4_term2;
                    System.out.println("end slice " + iSlice);
                }
                continue;
            }
            catch (Exception ex) {
