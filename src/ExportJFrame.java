    ...
    private void initComponents() {
        ...
        this.dirButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.dirButtonActionPerformed(evt);
            }
        });
        this.tfFirstTP.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.tfFirstTPActionPerformed(evt);
            }
        });
        this.tfFirstTP.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                ExportJFrame.this.tfFirstTPFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                ExportJFrame.this.tfFirstTPFocusLost(evt);
            }
        });
        this.jTextField2.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.jTextField2ActionPerformed(evt);
            }
        });
        this.jTextField2.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                ExportJFrame.this.jTextField2FocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                ExportJFrame.this.jTextField2FocusLost(evt);
            }
        });
        this.tfFirstZ.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.tfFirstZActionPerformed(evt);
            }
        });
        this.tfFirstZ.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                ExportJFrame.this.tfFirstZFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                ExportJFrame.this.tfFirstZFocusLost(evt);
            }
        });
        this.tfLastTP.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.tfLastTPActionPerformed(evt);
            }
        });
        this.tfLastTP.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                ExportJFrame.this.tfLastTPFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                ExportJFrame.this.tfLastTPFocusLost(evt);
            }
        });
        this.tfLastZ.addActionListener(new ActionListener(){

            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.tfLastZActionPerformed(evt);
            }
        });
        this.tfLastZ.addFocusListener(new FocusAdapter(){

            public void focusGained(FocusEvent evt) {
                ExportJFrame.this.tfLastZFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                ExportJFrame.this.tfLastZFocusLost(evt);
            }
        });
        ...
        this.coolButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.coolButtonActionPerformed(evt);
            }
        });
        ...
        this.nowayButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ExportJFrame.this.nowayButtonActionPerformed(evt);
            }
        });
    ...
    private boolean exportData(File targetDir) {
        ...
        for (int iF = 0; iF < theFiles.length; ++iF) {
            ...
            try {
                ...
                for (iS = 1; iS <= firstZ - 1; ++iS) {
                    stk.deleteSlice(1);
                }
                for (iS = lastZ + 1; iS <= depth; ++iS) {
                    stk.deleteSlice(stk.getSize());
                }
                ImagePlus copy = new ImagePlus("Stack", stk);
                this.writeTIFF(copy, fileName, targetDir.getAbsolutePath());
                continue;
            }
            catch (Exception ex) {
